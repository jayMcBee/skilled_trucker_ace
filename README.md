...
- `ios/` — the iPad build: Xcode project, SpriteKit scene, thumb pads, options sheet, two sound
  engines. See `ios/README.md`. The physics there is a port of `core.js`, which stays the reference.
